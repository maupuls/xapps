...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/xapps)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/xapps
```

A live public deployment of this template is available at [https://xapps.templates.workers.dev](https://xapps.templates.workers.dev)
